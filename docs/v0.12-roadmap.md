...
**Status: runner implemented; extended validation pending.**
...
The operation-bounded smoke has passed 4,000 churn operations. The planned
one-to-three-hour run remains release evidence to collect outside normal CI.
