...
strong-durability configuration. For v0.14.4:

```sh
git clone --depth 1 --branch v0.14.4 \
  https://github.com/puffball1567/koutendb.git
cd koutendb
KOUTENDB_VERSION=0.14.4 \
...
C++, and Go. A driver is not a standalone KoutenDB server:
